...
public partial class CropsForm : Form
{
    ...
    public CropsForm(CropGuiService cropService)
    {
        ...
        InitializeComponent();
        Load += async (s, e) => await LoadCrops();
    }
    ...
    private async Task LoadCrops()
    {
        ...
        dgvCrops.Columns["CropId"].Visible = false;
        dgvCrops.Columns["Name"].HeaderText = "اسم المحصول";
        dgvCrops.Columns["Unit"].HeaderText = "الوحدة";
    }
